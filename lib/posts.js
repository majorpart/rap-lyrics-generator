...
const HARDCODED_POST_METADATA = {
    ...
    'how-to-write-rap-lyrics': {
        ...
        image: '/assets/images/rap-lyrics-blog (2).webp',
        tag: 'TUTORIAL',
        date: '1/27/2025',
    ...
    'how-to-write-rap-lyrics-to-a-beat': {
        ...
        image: '/assets/images/rap-lyrics-blog (3).webp',
        tag: 'GUIDE',
        date: '1/27/2025',
    ...
    'what-makes-a-good-rap-lyric': {
        ...
        image: '/assets/images/rap-lyrics-blog (4).webp',
        tag: 'GUIDE',
        date: '1/27/2025',
    ...
    'how-can-i-turn-my-experiences-into-lyrics-using-an-ai-rap-lyric-generator': {
        ...
        image: '/assets/images/rap-lyrics-blog (5).webp',
        tag: 'GUIDE',
        date: '1/27/2025',
        gradient: 'from-purple-500 to-pink-500',
        html: `
    ...
    'how-can-one-obtain-inspiration-for-creating-rap-lyrics': {
        ...
        image: '/assets/images/rap-lyrics-blog (6).webp',
        tag: 'TIPS',
        date: '1/27/2025',
...
export function getPostImage(slug) {
    const postMetadata = {
        'how-to-get-a-good-rap-through-rap-lyrics-generator': '/assets/images/rap-lyrics-blog (1).webp',
        'how-to-write-rap-lyrics': '/assets/images/rap-lyrics-blog (2).webp',
        'how-to-write-rap-lyrics-to-a-beat': '/assets/images/rap-lyrics-blog (3).webp',
        'what-makes-a-good-rap-lyric': '/assets/images/rap-lyrics-blog (4).webp',
        'how-can-i-turn-my-experiences-into-lyrics-using-an-ai-rap-lyric-generator': '/assets/images/rap-lyrics-blog (5).webp',
        'how-can-one-obtain-inspiration-for-creating-rap-lyrics': '/assets/images/rap-lyrics-blog (6).webp'
    };
    return postMetadata[slug] || '/assets/images/rap-lyrics-blog (1).webp';
}
