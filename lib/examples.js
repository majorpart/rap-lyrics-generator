...
const HARDCODED_EXAMPLES = {
    ...
    'protecting-homeland-in-war': {
        ...
        content: `
            ...
            `s Homeland in War</h1></div><div class="prose prose-lg max-w-none whitespace-pre-line"><p>Yo, walk the streets of Gaza, feel the weight on my chest,<br>Concrete dreams crumbling, peace just a distant guest...</p><p>Content will be added here. For now, please use the description as a preview.</p></div>'
    },
...
But the real MVP was loyalty, and I gave it back.
            `s Keeper</h1></div><div class="prose prose-lg max-w-none whitespace-pre-line"><p>Street nines, remember that Chevy Malibu shine?<br>On the grind since crip, no lookin\' back, just time<br>From broken glass to stage, the dream ain\'t overpaid</p><p>Content will be added here. For now, please use the description as a preview.</p></div>'
    },
    'delivery-flow': {
        title: 'Delivery Flow',
...
The grind? It’s my anthem, forever in the game.
            `m out the door, on the grind, no cap,<br>Sipping coffee, rush hour grind, the streets get hot.<br>Riding scoot, the thermometer up north</p><p>Content will be added here. For now, please use the description as a preview.</p></div>'
    },
    'ghostwriter-no-more': {
...
The real artist is here, no more pawns, no more page!
            `s too thick<br>Watchin\' him shine, while I stay sick<br>Got the bars flowin\', yeah, I\'m on the grind</p><p>Content will be added here. For now, please use the description as a preview.</p></div>'
    },
    'our-broken-hit': {
...
That love was real, it just got rearranged.
            ` in the rain<br>Wrote the anthem \'bout the girl who lit my candle flame<br>Honeymoon gone sour, but the chorus stillin\'</p><p>Content will be added here. For now, please use the description as a preview.</p></div>'
    },
    'underdog-anthem': {
...
...The underdog's anthem, ain't nothin' left to chase. (4)
            ` bright, cold rainin\' down outside<br>That ain\'t no accident, that\'s all the suds I ever tried<br>Back in the day, yeah, I had rhymes that shook the whole block</p><p>Content will be added here. For now, please use the description as a preview.</p></div>'
    }
};
