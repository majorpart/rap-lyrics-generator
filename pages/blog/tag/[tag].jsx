        ...
        <>
                ...
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            '@type': 'CollectionPage',
                            name: `${displayTag} - Rap Lyrics Blog`,
                            description: `Explore ${posts.length} rap lyrics blog posts tagged with "${displayTag}"`,
                            url: url,
                            mainEntity: {
                                '@type': 'ItemList',
            ...
            <main className="min-h-screen bg-white" style={{ fontFamily: "'Slabo 27px', serif" }}>
                ...
                <div className="pt-20 pb-4 bg-white border-b border-gray-100">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        <nav className="text-sm text-gray-500">
                            ...
                            <span className="mx-2">/</span>
                            <span className="text-gray-900">Tag: {displayTag}</span>
                        </nav>
                    </div>
                </div>
                ...
                <div className="pt-4 pb-12 bg-white">
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="mb-8">
                            <h1 className="text-3xl md:text-4xl font-bold mb-2 text-gray-900">Tag: #{displayTag}</h1>
                        ...
                        {posts.length === 0 ? (
                            <div className="text-center py-12">
                                ...
                                <Link href="/blog" className="inline-block text-purple-600 hover:text-purple-500 transition-colors">
                                    Go back to Blog
                                </Link>
                            </div>
                        ) : (
